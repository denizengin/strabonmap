...
const CACHE_VERSION = 'strabon-map-56d4e36d22';
...
const RUNTIME_URLS = [
  ...
  // #176 mode-change flourish — transport-transition foley (car/air/sea).
  'assets/sfx/car-door.wav',
  'assets/sfx/jet-whoosh.wav',
  'assets/sfx/ferry-horn.wav',
  'core/theme.js',
  'core/trip-intro.js',
